...
1. By opening the issue for discussion: For instance, if you believe that you
   have uncovered a bug in Project Sample, creating a new issue in the `Call-for-Code-for-Racial-Justice/Truth-Loop`
...
3. By helping to resolve the issue: Typically this is done either in the form
   ...
   `Call-for-Code-for-Racial-Justice/Truth-Loop` in a concrete and reviewable manner.

## Submitting a Bug Report

When opening a new issue in the `Call-for-Code-for-Racial-Justice/Truth-Loop` issue tracker, please provide as much detail about your environment as possible.
...
functional guidelines of the Truth Loop project.
