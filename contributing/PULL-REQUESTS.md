...
* [Reviewing Pull Requests](#reviewing-pull-requests)
  ...
  * [Accept that there are different opinions about what belongs in policy-truth-frontend](#accept-that-there-are-different-opinions-about-what-belongs-in-project-sample)
...
policy-truth-frontend does not yet have a style guide.
...
If you are new to contributing to policy-truth-frontend, please try to do your best at
...
at least two policy-truth-frontend Collaborators (one Collaborator approval is enough if the
...
All policy-truth-frontend contributors who choose to review and provide feedback on Pull
...
1. Does this change make sense for policy-truth-frontend?
2. Does this change make policy-truth-frontend better, even if only incrementally?
...
policy-truth-frontend Collaborator landing the Pull Request but they can also be an
...
a particular change that makes policy-truth-frontend better, but the individual might just
not want to have anything to do with policy-truth-frontend ever again. The goal is not just
having good code.
...
Any policy-truth-frontend core Collaborator (any GitHub user with commit rights in the
`embrace-call-for-code/policy-truth-frontend` repository) is authorized to approve any other contributor's
...
### Accept that there are different opinions about what belongs in policy-truth-frontend
...
or functional reasons), then it belongs in policy-truth-frontend.
...
make policy-truth-frontend better. These may or may not make sense to add, but as with all
