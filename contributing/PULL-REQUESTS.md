...
* [Reviewing Pull Requests](#reviewing-pull-requests)
  ...
  * [Accept that there are different opinions about what belongs in truth loop](#accept-that-there-are-different-opinions-about-what-belongs-in-truth-loop)
...
Fork the project [on GitHub](https://github.com/Call-for-Code-for-Racial-Justice/Truth-Loop) and clone your fork
locally.

```text
$ git clone git@github.com:username/Truth-Loop.git
$ cd Truth-Loop
$ git remote add upstream https://github.com/Call-for-Code-for-Racial-Justice/Truth-Loop.git
$ git fetch upstream
```
...
Truth Loop does not yet have a style guide.
...
Fixes: https://github.com/Call-for-Code-for-Racial-Justice/Truth-Loop/issues/1337
Refs: http://eslint.org/docs/rules/space-in-parens.html
```

If you are new to contributing to Truth Loop, please try to do your best at
...
at least two Truth Loop Collaborators (one Collaborator approval is enough if the
...
All Truth Loop contributors who choose to review and provide feedback on Pull
...
1. Does this change make sense for Truth Loop?
2. Does this change make Truth Loop better, even if only incrementally?
...
Truth Loop Collaborator landing the Pull Request but they can also be an
...
a particular change that makes Truth Loop better, but the individual might just
not want to have anything to do with Truth Loop ever again. The goal is not just
having good code.
...
Any Truth Loop core Collaborator (any GitHub user with commit rights in the
`Call-for-Code-for-Racial-Justice/Truth-Loop` repository) is authorized to approve any other contributor's
...
### Accept that there are different opinions about what belongs in Truth Loop

Opinions on this vary, even among the members of the Technical Steering
Committee.

One general rule of thumb is that if Truth-Loop itself needs it (due to historic
or functional reasons), then it belongs in Truth Loop.
...
make Truth Loop better. These may or may not make sense to add, but as with all
