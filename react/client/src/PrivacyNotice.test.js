...
describe('PrivacyNotice component tests', () => {
  describe('if the Privacy has been accepted', () => {
    beforeEach(async () => {
      ...
      render(<Provider store={store}><PrivacyNotice/></Provider>)
    })
    it('should hide the privacyNotice', async () => {
      expect(screen.queryByTestId('privacyNotice')).toHaveClass('privacyNoticeClosed')
    })
  })
  describe('if the Privacy has NOT been accepted', () => {
    ...
    it('should show the privacyNotice', () => {
      expect(screen.queryByTestId('privacyNotice')).toHaveClass('privacyNoticeOpen')
    })
