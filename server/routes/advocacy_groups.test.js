...
describe('CRUD TESTS FOR /api/v1/advocacyGroups', function () {
...
let payload = {
  ...
  it('GET should not have the item.', async done => {
    let res = await request(app)
      .get('/api/v1/advocacyGroups').set('Accept', 'application/json').expect('Content-Type', /json/)
