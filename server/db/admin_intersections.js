...
const removeSinglePublicationIntersection = (artifactId, publicationId, callback) => {
    pool.query(
...
const removeSingleAdvocacyGroupIntersection = (artifactId, advocacyGroupId, callback) => {
    pool.query(
...
const addAdvocacyGroupIntersection = (artifactId, advocacyGroupId, callback) => {
    pool.query(
...
const removeSingleVideoTestimonialIntersection = (artifactId, videoTestimonialId, callback) => {
    pool.query(
...
const addVideoTestimonialIntersection = (artifactId, videoTestimonialId, callback) => {
    pool.query(
...
const removeSingleRelatedArtifactIntersection = (artifactId, relatedArtifactId, callback) => {
    pool.query(
...
const addRelatedArtifactIntersection = (artifactId, relatedArtifactId, callback) => {
    pool.query(
