const routes = [
  ...
  [
    'DELETE',
    /^\/api\/v1\/adminIntersections\/category\/[0-9]+\/[0-9]+$/,
    ['peasant', 'admin'],
  ],
  [
    'POST',
  ...
  [
    'DELETE',
    /^\/api\/v1\/adminIntersections\/category\/[0-9]+$/,
    ['peasant', 'admin'],
  ],
  [
    'DELETE',
    /^\/api\/v1\/adminIntersections\/geospatialDefinition\/[0-9]+\/[0-9]+$/,
    ['peasant', 'admin'],
  ],
  [
    'POST',
  ...
  [
    'DELETE',
    /^\/api\/v1\/adminIntersections\/geospatialDefinition\/[0-9]+$/,
    ['peasant', 'admin'],
  ],
  [
    'DELETE',
    /^\/api\/v1\/adminIntersections\/official\/[0-9]+\/[0-9]+$/,
    ['peasant', 'admin'],
  ],
  [
    'DELETE',
    /^\/api\/v1\/adminIntersections\/official\/[0-9]+$/,
    ['peasant', 'admin'],
  ],
  ['POST', /^\/api\/v1\/adminIntersections\/official$/, ['peasant', 'admin']],
  [
    'DELETE',
    /^\/api\/v1\/adminIntersections\/publication\/[0-9]+\/[0-9]+$/,
    ['peasant', 'admin'],
  ],
  [
    'POST',
  ...
  [
    'DELETE',
    /^\/api\/v1\/adminIntersections\/publication\/[0-9]+$/,
    ['peasant', 'admin'],
  ],
  [
    'DELETE',
    /^\/api\/v1\/adminIntersections\/advocacyGroup\/[0-9]+\/[0-9]+$/,
    ['peasant', 'admin'],
  ],
  [
    'POST',
  ...
  [
    'DELETE',
    /^\/api\/v1\/adminIntersections\/advocacyGroup\/[0-9]+$/,
    ['peasant', 'admin'],
  ],
  [
    'DELETE',
    /^\/api\/v1\/adminIntersections\/videoTestimonial\/[0-9]+\/[0-9]+$/,
    ['peasant', 'admin'],
  ],
  [
    'POST',
    /^\/api\/v1\/adminIntersections\/videoTestimonial\/[0-9]+$/,
    ['peasant', 'admin'],
  ],
  [
    'DELETE',
  ...
  [
    'DELETE',
    /^\/api\/v1\/adminIntersections\/relatedArtifact\/[0-9]+\/[0-9]+$/,
    ['peasant', 'admin'],
  ],
  [
    'POST',
  ...
  [
    'DELETE',
    /^\/api\/v1\/adminIntersections\/relatedArtifact\/[0-9]+$/,
    ['peasant', 'admin'],
  ],
  ...
  [
    'DELETE',
    /^\/api\/v1\/geospatialDefinitions\/[0-9]+$/,
    ['peasant', 'admin'],
  ],
  [
    'GET',
    /^\/api\/v1\/geospatialDefinitions\/name\/[A-Za-z-0-9]+$/,
    ['peasant', 'admin'],
  ],
  ...
  [
    'GET',
    /^\/api\/v1\/legislativeArtifacts\/list\/minDetail$/,
    ['peasant', 'admin'],
  ],
  [
    'GET',
    /^\/api\/v1\/legislativeArtifacts\/fullDetail\/[0-9]+$/,
    ['peasant', 'admin'],
  ],
  [
    'DELETE',
...
const authorize = (req, res, next) => {
  if (
    !isAuthorized(req.method, req._parsedOriginalUrl.pathname, req.user.role)
  ) {
