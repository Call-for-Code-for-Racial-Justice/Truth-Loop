const routes = [
  // Admin Intersection routes
  ['DELETE', /^\/api\/v1\/adminIntersections\/category\/[0-9]+\/[0-9]+$/, ['peasant','admin']],
  ['POST', /^\/api\/v1\/adminIntersections\/category\/[0-9]+\/[0-9]+$/, ['peasant','admin']],
  ['DELETE', /^\/api\/v1\/adminIntersections\/category\/[0-9]+$/, ['peasant','admin']],
  ['DELETE', /^\/api\/v1\/adminIntersections\/geospatialDefinition\/[0-9]+\/[0-9]+$/, ['peasant','admin']],
  ['POST', /^\/api\/v1\/adminIntersections\/geospatialDefinition\/[0-9]+\/[0-9]+$/, ['peasant','admin']],
  ['DELETE', /^\/api\/v1\/adminIntersections\/geospatialDefinition\/[0-9]+$/, ['peasant','admin']],
  ['DELETE', /^\/api\/v1\/adminIntersections\/official\/[0-9]+\/[0-9]+$/, ['peasant','admin']],
  ['DELETE', /^\/api\/v1\/adminIntersections\/official\/[0-9]+$/, ['peasant','admin']],
  ['POST', /^\/api\/v1\/adminIntersections\/official$/, ['peasant','admin']],
  ['DELETE', /^\/api\/v1\/adminIntersections\/publication\/[0-9]+\/[0-9]+$/, ['peasant','admin']],
  ['POST', /^\/api\/v1\/adminIntersections\/publication\/[0-9]+\/[0-9]+$/, ['peasant','admin']],
  ['DELETE', /^\/api\/v1\/adminIntersections\/publication\/[0-9]+$/, ['peasant','admin']],
  ['DELETE', /^\/api\/v1\/adminIntersections\/advocacyGroup\/[0-9]+\/[0-9]+$/, ['peasant','admin']],
  ['POST', /^\/api\/v1\/adminIntersections\/advocacyGroup\/[0-9]+\/[0-9]+$/, ['peasant','admin']],
  ['DELETE', /^\/api\/v1\/adminIntersections\/advocacyGroup\/[0-9]+$/, ['peasant','admin']],
  ['DELETE', /^\/api\/v1\/adminIntersections\/videoTestimonial\/[0-9]+\/[0-9]+$/, ['peasant','admin']],
  ['POST', /^\/api\/v1\/adminIntersections\/videoTestimonial\/[0-9]+$/, ['peasant','admin']],
  ['DELETE', /^\/api\/v1\/adminIntersections\/videoTestimonial\/[0-9]+$/, ['peasant','admin']],
  ['DELETE', /^\/api\/v1\/adminIntersections\/relatedArtifact\/[0-9]+\/[0-9]+$/, ['peasant','admin']],
  ['POST', /^\/api\/v1\/adminIntersections\/relatedArtifact\/[0-9]+\/[0-9]+$/, ['peasant','admin']],
  ['DELETE', /^\/api\/v1\/adminIntersections\/relatedArtifact\/[0-9]+$/, ['peasant','admin']],
