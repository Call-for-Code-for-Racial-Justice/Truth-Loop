    ...
    <div>
      <div className="bx--grid policy">
        <div className="bx--row">
          <div className="bx--col">
            <h6 className="light-text">
              {intl.formatMessage(messages.federal)}
            </h6>
          </div>
        </div>
        <div className="bx--row">
        ...
        <div className="bx--row">
          <div className="bx--col">
            <h6 className="light-text">
              {policy.officials && policy.officials.length > 0
                ? policy.officials[0].name
                : ''}
            </h6>
          </div>
        ...
        <div className="bx--row">
          <DetailsAccordion
            ...
            officialsAndSponsors={policy.officials}
      ...
      <Button
        data-testid={'tellMyStoryButton'}
        kind={'primary'}
        icon="img/video--add.svg"
        className="fixed-btn lower-btn"
      ...
      <Button
        ...
        className="fixed-btn bottom-btn"
        onClick={() => {
