export const PRIVACY_ACCEPTED_UPDATE =
  'truth-loop/privacy/privacyAcceptedUpdate'
export const PRIVACY_CANCELLED_UPDATE =
  'truth-loop/privacy/privacyCancelledUpdate'
