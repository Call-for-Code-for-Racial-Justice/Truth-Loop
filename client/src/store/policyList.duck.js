...
export const FETCH_POLICIES_FULFILLED =
  'truth-loop/policy/fetchPolicies/fulfilled'
export const FETCH_POLICIES_REJECTED =
  'truth-loop/policy/fetchPolicies/rejected'

export const POLICY_LIST_ITEM_DETAILS_UPDATE =
  'truth-loop/policyList/itemDetailsUpdate'
