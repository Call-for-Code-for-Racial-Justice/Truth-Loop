  ...
  return (
    <div className="bx--grid bx--grid--default policy-card">
      <div className="bx--row r1">
        <div className="bx--col-lg-12 bx--col-md-12 bx--col-sm-12">
          <div className="sentiment-bar">
            <div
              className={determineRowType()}
              data-testid={`sentimentBarRow${rowNumber}`}
            />
          </div>
        </div>
      </div>
      <div
        className="bx--row r2"
        role={'button'}
        data-testid={`policyTableItem${id}`}
        onClick={handlePolicyItemClicked}
      >
        <div
          className="bx--col-lg-4 bx--col-md-4 bx--col-sm-12 title"
          data-testid={'title'}
        >
          {title}
        </div>
        <div
          className="bx--col-lg-4 bx--col-md-4 bx--col-sm-12 summary"
          data-testid={'summary'}
        >
          {summary}
        </div>
        <div
          className="bx--col-lg-4 bx--col-md-4 bx--col-sm-12 introdate"
          data-testid={'dateIntroduced'}
        >
