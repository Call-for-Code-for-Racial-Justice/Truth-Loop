...
var TableToolbarSearch = function TableToolbarSearch(_ref) {
  ...
  var searchContainerClasses = (0, _classnames.default)((_cx = {}, _defineProperty(_cx, searchContainerClass, searchContainerClass), _defineProperty(_cx, "".concat(prefix, "--toolbar-action"), true), _defineProperty(_cx, "".concat(prefix, "--toolbar-search-container-active"), expanded), _defineProperty(_cx, "".concat(prefix, "--toolbar-search-container-expandable"), !persistant), _defineProperty(_cx, "".concat(prefix, "--toolbar-search-container-persistant"), persistant), _cx));
...
TableToolbarSearch.propTypes = {
   ...
   */
  persistant: _propTypes.default.bool
};
