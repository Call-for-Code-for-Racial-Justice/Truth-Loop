...
describe('Toggle', function () {
  describe('Renders as expected', function () {
    ...
    it('Can have a labelA', function () {
      ...
      expect(wrapper.find(".".concat(prefix, "--toggle__text--left")).text()).toEqual('labelA-test');
    });
    it('Can have a labelB', function () {
      wrapper.setProps({
        labelB: 'labelB-test'
      });
      expect(wrapper.find(".".concat(prefix, "--toggle__text--right")).text()).toEqual('labelB-test');
    });
  });
