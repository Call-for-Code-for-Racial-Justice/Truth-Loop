...
describe('TextInput', function () {
  describe('renders as expected', function () {
    ...
    describe('input', function () {
      ...
      it('should count length increases in text input value', function () {
        var event = {
          target: {
            value: 'z'
          }
        ...
        expect(wrapper.find("span.".concat(prefix, "--text-input--character-counter")).text()).toBe('1/10');
      });
      it('should count length decreases in text input value', function () {
        var event = {
          target: {
            value: ''
          }
        ...
        textInput().simulate('input', event);
        expect(wrapper.find("span.".concat(prefix, "--text-input--character-counter")).text()).toBe('0/10');
      });
