...
function (_React$Component) {
  ...
  _createClass(ControlledPasswordInputApp, [{
    ...
    value: function render() {
      return React.createElement(TextInput.ControlledPasswordInput, _extends({
...
storiesOf('TextInput', module).addDecorator(withKnobs).add('Default', function () {
  ...
  return React.createElement(TextInput.PasswordInput, props.passwordInput());
}, {
  info: {
    text: "\n          Text field with password visibility toggle.\n        "
  }
}).add('Fully controlled toggle password visibility', function () {
  return React.createElement(ControlledPasswordInputApp, null);
}, {
  info: {
