...
import { Content, Header, HeaderMenuButton, HeaderName, HeaderNavigation, HeaderMenu, HeaderMenuItem, HeaderGlobalBar, HeaderGlobalAction, HeaderPanel, SkipToContent, SideNav, // Temporarily comment these out until they are needed again
// SideNavHeader,
// SideNavDetails,
// SideNavSwitcher,
SideNavItems, SideNavLink, SideNavMenu, SideNavMenuItem, Switcher, SwitcherItem, SwitcherItemLink } from '../UIShell';
...
storiesOf('UI Shell', module).add('Header', withReadme(readme, function () {
...
})).add('Header Base w/ Menu', withReadme(readme, function () {
  return React.createElement(Header, {
    "aria-label": "IBM Platform Name"
  }, React.createElement(HeaderMenuButton, {
    "aria-label": "Open menu",
    onClick: action('Menu clicked')
  }), React.createElement(HeaderName, {
    href: "#",
  ...
  return React.createElement(Header, {
    ...
    expanded: true
  }, React.createElement(Switcher, null, React.createElement(SwitcherItem, null, React.createElement(SwitcherItemLink, {
    isSelected: true,
    href: "javascript:void(0)"
  }, "Link")), React.createElement(SwitcherItem, null, React.createElement(SwitcherItemLink, {
    href: "javascript:void(0)"
  }, "Link")), React.createElement(SwitcherItem, null, React.createElement(SwitcherItemLink, {
    href: "javascript:void(0)"
  }, "Link")), React.createElement(SwitcherItem, null, React.createElement(SwitcherItemLink, {
...
})).add('SideNav w/ Header', withReadme(readme, function () {
