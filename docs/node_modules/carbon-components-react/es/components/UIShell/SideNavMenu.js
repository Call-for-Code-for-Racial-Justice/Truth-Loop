...
function (_React$Component) {
  ...
  _createClass(SideNavMenu, [{
    ...
    value: function render() {
      ...
      var className = cx((_cx = {}, _defineProperty(_cx, "".concat(prefix, "--side-nav__item"), true), _defineProperty(_cx, "".concat(prefix, "--side-nav__item--active"), isActive), _defineProperty(_cx, "".concat(prefix, "--side-nav__item--icon"), IconElement), _defineProperty(_cx, customClassName, !!customClassName), _cx));
