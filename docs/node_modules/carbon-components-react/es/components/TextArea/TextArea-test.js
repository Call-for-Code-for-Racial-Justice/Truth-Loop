...
describe('TextArea', function () {
  describe('should render as expected', function () {
    ...
    describe('textarea', function () {
      ...
      it('should count length increases in textarea value', function () {
        var event = {
          target: {
            value: 'z'
          }
        ...
        expect(wrapper.find("span.".concat(prefix, "--text-area--character-counter")).text()).toBe('1/10');
      });
      it('should count length decreases in textarea value', function () {
        var event = {
          target: {
            value: ''
          }
        ...
        textarea().simulate('input', event);
        expect(wrapper.find("span.".concat(prefix, "--text-area--character-counter")).text()).toBe('0/10');
      });
