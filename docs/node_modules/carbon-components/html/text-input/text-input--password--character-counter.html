...
<div  data-text-input 
  class="bx--form-item bx--text-input-wrapper bx--password-input-wrapper bx--text-input-wrapper--character-counter">
  <div class="bx--text-input__character-counter-title">
    <label for="text-input-3" class="bx--label">Text Input label</label>
    <span class="bx--text-input--character-counter">
      <span class="bx--text-input--character-counter--length">0</span>/<span
        class="bx--text-input--character-counter--maxlength">100</span>
    </span>
  </div>
  <div class="bx--text-input__field-wrapper">
    <input id="text-input-3" type="password"
      class="bx--text-input bx--password-input"
      placeholder="Placeholder text" data-toggle-password-visibility maxlength="100"
      >
    <button class="bx--text-input--password__visibility" aria-label="Show password">
...
<div  data-text-input  class="bx--form-item bx--text-input-wrapper bx--password-input-wrapper
   bx--text-input-wrapper--character-counter">
  <div class="bx--text-input__character-counter-title">
  ...
  <div class="bx--text-input__field-wrapper" data-invalid>
    ...
    <input data-invalid id="text-input-4" type="password"
      ...
      placeholder="Placeholder text"  maxlength="100" 
...
<div  data-text-input 
  ...
  <div class="bx--text-input__character-counter-title">
    ...
    <span class="bx--text-input--character-counter bx--text-input--character-counter--disabled">
      <span class="bx--text-input--character-counter--length">0</span>/<span
        class="bx--text-input--character-counter--maxlength">100</span>
    </span>
  </div>
