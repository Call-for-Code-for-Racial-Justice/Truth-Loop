...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-kcip6qk6dd">Show
  modal</button>

<div data-modal id="modal-kcip6qk6dd" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-kcip6qk6dd-label" aria-describedby="modal-kcip6qk6dd-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-kcip6qk6dd-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-kcip6qk6dd-heading">Modal heading</p>
