...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-tf5dr7qxpe">Show
  modal</button>

<div data-modal id="modal-tf5dr7qxpe" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-tf5dr7qxpe-label" aria-describedby="modal-tf5dr7qxpe-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-tf5dr7qxpe-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-tf5dr7qxpe-heading">Modal heading</p>
